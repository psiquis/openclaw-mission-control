...
import { FullChatPanel } from '@/components/panels/full-chat-panel'
...
function ContentRouter({ tab }: { tab: string }) {
  ...
  switch (tab) {
    ...
    case 'sessions':
      return (
        <div className="rounded-xl border border-border bg-card overflow-hidden h-[calc(100vh-8.75rem)] min-h-[560px]">
          <FullChatPanel />
        </div>
      )
    case 'logs':
